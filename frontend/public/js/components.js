...
const translations = {
  en: {
    ...
    confRegOnlinePayment: 'Online Payment (Credit/Debit Card via Stripe)',
    confRegBankTransfer: 'Bank Transfer',

    confRegZeffyTitle: '💳 Secure Online Payment via Stripe',
    confRegZeffyDesc1: 'ISRS uses Stripe, a secure payment platform trusted by millions worldwide.',
    confRegZeffyDesc2: 'When you proceed to payment, you\'ll enter your card details securely on this page.',
    confRegZeffyImportant: 'Optional:',
    confRegZeffyTip: 'You can choose to cover the credit card processing fees (approximately 3%) so that 100% of your registration fee goes to ISRS. <strong>This is completely optional.</strong>',
    confRegZeffyFee: 'Your conference registration fee supports the conference and ISRS\'s mission to advance shellfish restoration worldwide.',
  ...
  es: {
    ...
    confRegOnlinePayment: 'Pago en Línea (Tarjeta de Crédito/Débito vía Stripe)',
    confRegBankTransfer: 'Transferencia Bancaria',

    confRegZeffyTitle: '💳 Pago Seguro en Línea vía Stripe',
    confRegZeffyDesc1: 'ISRS usa Stripe, una plataforma de pago segura confiable por millones en todo el mundo.',
    confRegZeffyDesc2: 'Cuando proceda al pago, ingresará los detalles de su tarjeta de forma segura en esta página.',
    confRegZeffyImportant: 'Opcional:',
    confRegZeffyTip: 'Puede optar por cubrir las tarifas de procesamiento de tarjetas de crédito (aproximadamente 3%) para que el 100% de su tarifa de inscripción vaya a ISRS. <strong>Esto es completamente opcional.</strong>',
    confRegZeffyFee: 'Su tarifa de inscripción a la conferencia apoya la conferencia y la misión de ISRS de avanzar la restauración de mariscos en todo el mundo.',
  ...
  fr: {
    ...
    confRegOnlinePayment: 'Paiement en Ligne (Carte de Crédit/Débit via Stripe)',
    confRegBankTransfer: 'Virement Bancaire',

    confRegZeffyTitle: '💳 Paiement Sécurisé en Ligne via Stripe',
    confRegZeffyDesc1: 'ISRS utilise Stripe, une plateforme de paiement sécurisée approuvée par des millions de personnes dans le monde.',
    confRegZeffyDesc2: 'Lorsque vous procéderez au paiement, vous entrerez les détails de votre carte en toute sécurité sur cette page.',
    confRegZeffyImportant: 'Optionnel:',
    confRegZeffyTip: 'Vous pouvez choisir de couvrir les frais de traitement des cartes de crédit (environ 3%) afin que 100% de vos frais d\'inscription aillent à ISRS. <strong>Ceci est entièrement optionnel.</strong>',
    confRegZeffyFee: 'Vos frais d\'inscription à la conférence soutiennent la conférence et la mission d\'ISRS de faire progresser la restauration des mollusques dans le monde entier.',
    ...
    <nav class="navbar" role="navigation" aria-label="Main navigation">
      ...
      <div class="header-controls">
        ...
        <div class="social-links-header">
          <a href="#" class="social-link-header" aria-label="LinkedIn - Coming Soon" title="Coming Soon">
      ...
      <div class="footer-content">
        <div class="footer-section footer-logo-section">
          ...
          <div class="footer-social-links">
            <a href="#" class="footer-social-link" aria-label="LinkedIn - Coming Soon" title="Coming Soon">
